...
nix run github:nix-community/nixos-anywhere -- --disk-encryption-keys /tmp/disk-1.key /tmp/disk-1.key --flake /home/tristan/nixos-config#vm --extra-files "$temp" --ssh-port 22 --debug root@192.168.1.145
